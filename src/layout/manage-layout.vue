<template>
  <div class="layout">
    <tiny-container :aside-width="mobileStore.asideWidth" :pattern="myPattern">
      <template #header>
        <tiny-layout>
...
<script lang="ts" setup>
  ...
  import { useAppStore, articleStore, useMobileStore } from '@/store';

    // eslint-disable-next-line import/extensions
  import Footer from '@/components/footer/index.vue';
  import NavBar from '@/components/navbar/index.vue';
  import Theme from '@/components/theme/index.vue';
  import SpaceMenu from '@/components/menu/spaceMenu.vue';
