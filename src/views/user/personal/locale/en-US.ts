export default {
  ...
  'userInfo.job': 'Job',
  'userInfo.description': 'Personal Profile',
  'userInfo.email': 'Email',

  'userInfo.status.total': 'Total',
  'userInfo.status.create': 'Created',
  'userInfo.status.join': 'Invited',

  'menu.user.info': 'User Center',
  'userInfo.tab.team': 'My Team',
  'userInfo.tab.book': 'My Wiki',
  'userInfo.tab.article': 'My Article',
