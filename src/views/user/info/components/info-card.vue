...
<script lang="ts" setup>
  ...
  const InfoNum = ref([
    {
      value: userStore.summary.total,
      class: 'plan-pass',
      text: 'userInfo.status.total',
      img: info1,
    },
    {
      value: userStore.summary.create,
      class: 'plan-overdue',
      text: 'userInfo.status.create',
      img: info2,
    },
    {
      value: userStore.summary.join,
      class: 'plan-limit',
      text: 'userInfo.status.join',
      img: info3,
    }
  ])
