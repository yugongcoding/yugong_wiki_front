<template>
  <div class="navbar">
    <div class="collapse-button">
      <div>
        <iconIconSandwichCollapse v-show="showCollapse" @click="showCollapse=!showCollapse" style="width: 25px; height: 25px"/>
        <iconIconSandwichExpand v-show="!showCollapse" @click="showCollapse=!showCollapse"  style="width: 25px; height: 25px"/>
      </div>
    </div>
    <RightSlide v-show="!showCollapse" class="right-slide-menu" @click="showCollapse=!showCollapse"/>
    <div class="left-side">
    ...
    <div class="right-side">
      <ul class="right-menu">
        <li>
        <span><RouterLink to="/">首页</RouterLink></span>
        </li>
        <li>
          <span><RouterLink to="/about">关于我们</RouterLink></span>
        </li>
        <li>
          <span><RouterLink to="/download">下载中心</RouterLink></span>
        </li>
        <li>
          <span @click="help">{{ $t('settings.navbar.help') }}</span>
        </li>
        <li>
          <span><RouterLink to="/space/team">创作中心</RouterLink></span>
        </li>
        <li @click="changeLan">
      ...
      <tiny-button v-show="!(userStore.loginStatus)" type="primary" @click="login">登录/注册</tiny-button>
