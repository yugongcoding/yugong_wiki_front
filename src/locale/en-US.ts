...
import localePersonal from '@/views/user/personal/locale/en-US';

import localeSpace from '@/views/space/locale/en-US';
...
export default {
  'menu.team': 'Team Space',
  'menu.book': 'Knowledge Space',
  'menu.space': 'Knowledge Management',
